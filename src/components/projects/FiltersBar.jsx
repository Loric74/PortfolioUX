...
export default function FiltersBar({ activeFilter, onFilter, count }) {
  return (
    <div className="relative z-10 px-16 pt-10 flex gap-3 flex-wrap items-center max-[700px]:px-5">
      <span className="font-mono text-[0.65rem] tracking-[0.3em] text-[rgba(230,230,230,0.3)] uppercase mr-2">
        Filtrer :
      </span>
        ...
        <button
          ...
          className={`font-mono text-[0.7rem] tracking-[0.15em] px-5 py-[9px] border uppercase transition-all duration-300 clip-btn-xs cursor-pointer
            ${activeFilter === f.id
              ...
              : 'border-[rgba(0,245,255,0.15)] text-[rgba(230,230,230,0.45)] bg-transparent hover:border-cyan hover:text-cyan hover:bg-[rgba(0,245,255,0.05)] hover:shadow-cyan'
            }`}
        >
          {f.label}
        </button>
