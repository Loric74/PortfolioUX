    ...
    <div className="relative z-10 px-16 py-12 max-[700px]:px-5">
      ...
      >
        ...
        <div className="relative bg-bg2 min-h-[420px] flex items-center justify-center overflow-hidden border-r border-[rgba(0,245,255,0.08)] max-[1000px]:min-h-[280px]">
          ...
          <div className="absolute inset-0 bg-[rgba(0,0,0,0.45)] z-[1] flex items-center justify-center">
            <span className="font-orbitron text-[1.6rem] font-black text-white tracking-[0.12em] drop-shadow-[0_2px_20px_rgba(0,0,0,0.8)]">
              Les Bambinets
            </span>
          </div>
          <span className="absolute top-5 left-5 font-mono text-[0.65rem] text-[rgba(0,245,255,0.35)] tracking-[0.2em] z-[2]">
            {p.num}
          </span>
        ...
        <div className="px-10 py-12 flex flex-col justify-center max-[1000px]:px-8 max-[1000px]:py-8">
          ...
          <p className="text-[0.92rem] leading-[1.75] text-[rgba(230,230,230,0.6)] mb-6">{p.desc}</p>
          ...
          <div className="grid grid-cols-3 gap-4 mb-7 p-5 bg-[rgba(0,245,255,0.02)] border border-[rgba(0,245,255,0.07)]">
            {p.metrics.map((m) => (
              <div key={m.label} className="text-center">
                ...
                <span className="font-mono text-[0.6rem] text-[rgba(230,230,230,0.35)] tracking-[0.12em] uppercase mt-1 block">{m.label}</span>
              </div>
            ))}
          </div>
