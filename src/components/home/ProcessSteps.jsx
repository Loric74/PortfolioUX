...
export default function ProcessSteps() {
  return (
    <section className="relative z-10 px-16 pt-8 pb-[100px] bg-gradient-to-b from-transparent via-[rgba(0,245,255,0.01)] to-transparent max-[900px]:px-6 max-[900px]:py-[60px]">
      ...
      <div className="flex gap-0 mt-[50px] relative items-start max-[900px]:flex-col max-[900px]:gap-0">
        {processSteps.map((step, i) => (
          ...
          >
            ...
            {/* Hex node */}
            <div className="w-[60px] h-[60px] relative flex-shrink-0 mx-auto mb-5 flex items-center justify-center max-[900px]:mx-0 max-[900px]:mb-0">
            ...
            <div>
              <p className="font-mono text-[0.6rem] max-[700px]:text-[0.55rem] text-[rgba(0,245,255,0.35)] tracking-[0.2em] mb-2">{step.ref}</p>
              <p className="font-orbitron text-[0.78rem] max-[700px]:text-[0.7rem] font-semibold text-white mb-2">{step.name}</p>
              <p className="text-[0.82rem] max-[700px]:text-[0.72rem] leading-[1.6] text-[rgba(230,230,230,0.45)]">{step.desc}</p>
            </div>
          </div>
        ))}
      </div>
