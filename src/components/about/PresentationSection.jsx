          ...
          <div>
            ...
            <div className="flex gap-4 flex-wrap mt-6">
              <button
                ...
                className="font-mono text-[0.78rem] tracking-[0.18em] px-8 py-3.5 uppercase border border-cyan text-cyan bg-transparent shadow-cyan clip-btn transition-all duration-300 hover:bg-cyan hover:text-bg flex items-center gap-2 cursor-none"
              >
                <Mail size={14} />
